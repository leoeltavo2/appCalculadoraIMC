...
struct cerebroIMC {
    ...
    mutating func calcularIMC(peso: Float, altura: Float){
        ...
        if valorIMC < 18.5 {
            imc = objetoIMC(valor: valorIMC, mensaje: "Probabilidad de anemia", color:  #colorLiteral(red: 0.8078431487, green: 0.02745098062, blue: 0.3333333433, alpha: 1), imagen: nil)
            print(valorIMC)
        }
